...
async function loadStays() {
    ...
    try {
        ...
        stayList.innerHTML = ''; // Clear the list before reloading
        stays.forEach(stay => {
            console.log('Processing stay:', stay);
            const stayItem = document.createElement('div');
            stayItem.className = 'card bg-white shadow-md rounded-lg p-4 hover:shadow-lg transition-shadow duration-300';
            stayItem.innerHTML = `
